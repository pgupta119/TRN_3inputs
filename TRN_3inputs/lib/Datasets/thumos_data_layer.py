...
class TRNTHUMOSDataLayer(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        optical_inputs = torch.as_tensor(camera_inputs.astype(np.float32))
        ...
        return camera_inputs, motion_inputs, optical_inputs, enc_target, dec_target.view(-1, enc_target.shape[-1])
